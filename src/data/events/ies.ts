...
export const iesEvents: Event[] = [
  {
    id: "ies-e1",
    slug: "ies-symposium",
    title: "Industrial Electronics Symposium",
    ...
    date: "2027-02-10T09:00:00Z",
    endDate: "2027-02-10T17:00:00Z",
    venue: "NSSCE Main Auditorium",
    societyId: "ies", // Fallback for execom
    status: "upcoming",
